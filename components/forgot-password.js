...
export default function PasswordForgot() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://projet-back-end.vercel.app/forgot-password", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        setMessage(result.message || "Un lien de réinitialisation vous a été envoyé par email.");
      } else {
